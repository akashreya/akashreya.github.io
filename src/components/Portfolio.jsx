  ...
  return (
    <section id="portfolio" className="component">
      ...
      <div className="projects-tab">
        <div className="inset-0 mb-12 p-4">
        ...
        <div
          key={selectedFilter}
          className="grid grid-cols-2 gap-16 items-center justify-between"
        >
          ...
          {filteredProjects.length === 0 && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="text-gray-400 text-lg italic text-center py-16 col-span-2"
            >
              No projects found.
            </motion.div>
          )}
